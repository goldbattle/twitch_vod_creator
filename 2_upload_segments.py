...
from utilities_config import load_config
...
def main():
    ...
    path_yt_creds = os.path.join(os.path.dirname(path_base), "profiles", config["yt_creds"])
    path_yt_secrets = os.path.join(os.path.dirname(path_base), "profiles", config["yt_secrets"])
